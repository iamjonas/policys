...
- **OpenAI** — Goal and calendar data is sent to generate weekly reset insights. No personally identifiable information (name, email) is included in these requests.
...
Questions about your privacy? [Open an issue](https://github.com/iamjonas/policys/issues).
